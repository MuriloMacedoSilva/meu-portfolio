    ...
    <section className=" w-full pb-[50px] px-[70px] -bg-linear-180 from-white/90 to-gray-50/90 flex flex-col items-center gap-17">
      ...
      <div className="w-[90%] grid grid-cols-2 gap-15 justify-between sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          ...
          <p className="text-[23px] text-blue-950 font-medium">JavaScript</p>
        </div>
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" />
          <p className="text-[23px] text-blue-950 font-medium">React.Js</p>
        </div>
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" />
          <p className="text-[23px] text-blue-950 font-medium">Tailwind CSS</p>
        </div>
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
        ...
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          ...
          <p className="text-[23px] text-blue-950 font-medium">Jupyter</p>
        </div>
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" />
          <p className="text-[23px] text-blue-950 font-medium">Python</p>
        </div>
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
        ...
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          ...
          <p className="text-[23px] text-blue-950 font-medium">SpringBoot</p>
        </div>
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
        ...
        <div className="hover:bg-white/30 p-[8px] rounded transition duration-250 flex flex-col items-center justify-center">
          ...
          <p className="text-[23px] text-blue-950 font-medium">GitHub</p>
        </div>
      </div>
    </section>
  );
